...
Please use minecraft terms always as they appear in the file (e.g. "blokk", "entitás". Colors like "vörös" for "red" should be translated as "vörös", not "piros". "Redstone" is a trademark keep it the same in hungarian). If you are unsure about a translation, please consult the original Hungarian file or ask for help.
