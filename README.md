...
This is a modern NeoForge-based modpack for Minecraft 1.21.1 designed to offer a seamless blend of automation, engineering, and creativity. Originally developed for private multiplayer sessions with friends, this pack has been fine-tuned to provide an engaging experience that others can enjoy as well.

At its core, the modpack revolves around the powerful **Create** mod and its many expansions, enabling players to construct intricate contraptions, automate complex tasks, build massive trains, and even construct physics-based flying ships! Whether you’re designing advanced machinery, setting up sophisticated production lines, or creating stunning architectural marvels, this pack provides the tools to bring your ideas to life.
...
**IMPORTANT**: This modpack needs at least **6GB+ RAM** allocated to Java. **8GB** is recommended.
...
## Core & Create Addons
<details>
  <summary>Because we love Create! This includes Create Aeronautics for flying ships, Copycats+ for building, Steam 'n' Rails for trains, and a bunch of other add-ons for decoration and automation.</summary>
...
## Building & Deco
<details>
  <summary>Decorate your bases and factories with modern furniture and extra building blocks.</summary>

- [Amendments](https://modrinth.com/mod/amendments) - Small tweaks and additions to vanilla blocks (like ladders, cauldrons, etc.).
- [AntiBlocksReChiseled](https://modrinth.com/mod/antiblocksrechiseled) - Plain, solid color blocks for styling.
- [Supplementaries](https://modrinth.com/mod/supplementaries) - Many functional and aesthetic block additions.
</details>

## QoL & Utilities
<details>
  <summary>A collection of quality-of-life additions, maps, HUD enhancements, and inventory tweaks.</summary>

- [3D Skin Layers](https://modrinth.com/mod/3dskinlayers) - Renders skin layers in 3D.
- [Advancement Plaques](https://modrinth.com/mod/advancement-plaques) - Custom popups for advancements.
- [Ambient Environment](https://modrinth.com/mod/ambient-environment) - Smoother color transitions in biomes.
- [Better Advancements](https://modrinth.com/mod/better-advancements) - Improved advancement screen.
- [Chat Plus](https://modrinth.com/mod/chat-plus) - Custom chat styling.
- [Curios API](https://modrinth.com/mod/curios) - Accessory slots.
...
- [Inventory Essentials](https://modrinth.com/mod/inventory-essentials) - Fast inventory management.
...
## Optimizations
<details>
  <summary>Performance boosting mods to ensure high FPS and stable frame times, including shader support.</summary>

- [Sodium](https://modrinth.com/mod/sodium) - Incredible performance booster.
- [Lithium](https://modrinth.com/mod/lithium) - General game physics and chunk optimization.
...
# Servers
For dedicated servers, ensure that the client-side only mods (like rendering, shaders, and client UI enhancements) are disabled or excluded:
- `iris`
- `sodium`
- `immediatelyfast`
- `entityculling`
